...
constexpr unsigned char G0x7FF685631000[GMAX_LOOP_COUNT] =
{
	0xAD, 0xD8, 0xCB, 0xCB,
	0x9D, 0x97, 0xCB, 0xC4,
	0x92, 0xA1, 0xD2, 0xD7,
...
int main()
{
	...
	Answer[GMAX_LOOP_COUNT - 2] = G0x7FF685631000[GMAX_LOOP_COUNT - 2];
	...
	for (size_t LoopCount = GMAX_LOOP_COUNT - 3; LoopCount >= 0; --LoopCount)
	{
		...
		{
			if (G0x7FF685631000[LoopCount] == Char + Answer[LoopCount + 1])
			{
